...
public class UnexpectedStatementTypeException extends RpgleFormatterException {
    ...
    public UnexpectedStatementTypeException(StatementType statementType) {
        super(String.format("Unexpected token of type: %s", statementType != null ? statementType.name() : "[null]"));
    }
}
